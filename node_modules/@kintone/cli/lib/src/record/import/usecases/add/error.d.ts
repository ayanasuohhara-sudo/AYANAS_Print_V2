...
export declare class AddRecordsError extends CliKintoneError {
    readonly detail: string;
    private readonly chunkSize;
    private readonly records;
    private readonly numOfSuccess;
    private readonly numOfSuccessInCurrentChunk;
    private readonly numOfTotal;
    private readonly recordSchema;
    /** *
     * @param cause
     ...
     */
    constructor(cause: unknown, records: LocalRecord[], currentIndex: number, recordSchema: RecordSchema, lastSucceededRecord?: LocalRecord);
