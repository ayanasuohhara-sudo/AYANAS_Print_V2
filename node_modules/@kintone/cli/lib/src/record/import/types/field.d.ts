...
export type Creator = FieldWith<{
    code: string;
}>;
export type CreatedTime = FieldWith<string>;
export type Modifier = FieldWith<{
    code: string;
}>;
