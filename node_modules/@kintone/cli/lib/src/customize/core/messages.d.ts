...
export declare const messages: {
    ...
    readonly M_GenerateManifestFile: {
        readonly en: "Generating manifest file based on the current customization setting on kintone app";
        readonly ja: "kintoneのアプリのカスタマイズ設定を元にマニフェストファイルを生成しています";
    };
    ...
    readonly M_CommandInitFinish: {
        readonly en: "file has been created";
        readonly ja: "を生成しました";
    };
    readonly M_CommandExportFinish: {
        readonly en: "Exported customization files successfully";
        readonly ja: "カスタマイズファイルのエクスポートが完了しました";
    };
    readonly E_Updated: {
 ...
 * @param key
 */
export declare const getMessage: (lang: Lang, key: keyof typeof messages) => "Please specify manifest file" | "マニフェストファイルを指定してください" | "Input your kintone's base URL (https://example.cybozu.com):" | "kintoneのベースURLを入力してください (https://example.cybozu.com):" | "Input your username:" | "ログイン名を入力してください:" | "Input your password:" | "パスワードを入力してください:" | "Input your app id:" | "アプリIDを入力してください:" | "Start uploading customization files" | "カスタマイズのアップロードを開始します" | "JavaScript/CSS files have been uploaded!" | "JavaScript/CSS ファイルをアップロードしました!" | "Failed to upload JavaScript/CSS files" | "JavaScript/CSS ファイルのアップロードに失敗しました" | "has been uploaded!" | "をアップロードしました!" | "Customize setting has been updated!" | "JavaScript/CSS カスタマイズの設定を変更しました!" | "Generating manifest file based on the current customization setting on kintone app" | "kintoneのアプリのカスタマイズ設定を元にマニフェストファイルを生成しています" | "Download the current customization files on kintone app" | "kintoneのアプリからカスタマイズ設定されたファイルをダウンロードしています" | "file has been created" | "を生成しました" | "Exported customization files successfully" | "カスタマイズファイルのエクスポートが完了しました" | "Failed to update customize setting" | "JavaScript/CSS カスタマイズの設定の変更に失敗しました" | "Setting has been deployed!" | "運用環境に反映しました!" | "Failed to authenticate. Please confirm your username, password, and kintone's base URL" | "認証に失敗しました。ログイン名、パスワード、ベース URL を確認してください" | "Failed to deploy setting" | "運用環境への反映に失敗しました" | "Wait for deploying completed..." | "運用環境への反映の完了を待っています..." | "Watching for file changes..." | "ファイルの変更を監視しています..." | "An error occurred, retry" | "エラーが発生しました。リトライします" | "An error occurred, exit process. Please check if you passed proper arguments and manifest file" | "エラーが発生しました。引数の値と、マニフェストファイルに正しい値が入力されているか確認してください";
