...
var SpaceClient_1 = require("./client/SpaceClient");
var FileClient_1 = require("./client/FileClient");
var PluginClient_1 = require("./client/PluginClient");
var SearchClient_1 = require("./client/SearchClient");
...
var KintoneRestAPIClient = /** @class */ (function () {
    function KintoneRestAPIClient(options) {
        ...
        this.search_ = new SearchClient_1.SearchClient(httpClient, guestSpaceId);
    }
