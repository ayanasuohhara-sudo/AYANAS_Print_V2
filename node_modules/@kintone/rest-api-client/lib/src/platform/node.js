...
var readFile = (0, node_util_1.promisify)(node_fs_1.default.readFile);
...
var buildHttpsAgentConfig = function (_a) {
    ...
    if (clientCertAuth !== undefined) {
        var pfx = "pfx" in clientCertAuth
            ? clientCertAuth.pfx
            : node_fs_1.default.readFileSync(clientCertAuth.pfxFilePath);
        var defaultHttpsAgent = new node_https_1.default.Agent({
            pfx: pfx,
...
var buildHeaders = function (params) {
    ...
    return {
        "User-Agent": "Node.js/".concat(process.version, "(").concat(node_os_1.default.type(), ") ").concat(package_json_1.default.name, "@").concat(package_json_1.default.version).concat(userAgent ? " ".concat(userAgent) : ""),
    };
};
